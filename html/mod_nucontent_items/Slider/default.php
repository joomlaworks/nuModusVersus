...
$count = 3; // Change the count to the number of items to show per slide
...
<div id="nuContentModuleBox<?php echo $module->id; ?>" class="nuContentItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?> scrollerModule">
  ...
  <ul class="items twelve">
    <?php foreach ($items as $key=>$item):	?>
    <li class="<?php echo (($key+1)%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?> six item">
      
      
      <?php if(($params->get('itemImage') && $item->image) || ($params->get('itemReadMore') && $item->fulltext)): ?>      
      ...
      <div class="detailsWrap">
        ...
        <div class="moduleItemAuthor itemAuthor"><?php echo $item->author; ?></div>
        <?php endif; ?>
     ...
     <div class="titleWrap">
      ...
      <span class="moduleItemDateCreated"><?php //echo JText::_('NUCONTENT_WRITTEN_ON') ;?> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_NUMUZIK')); ?></span>
      <?php endif; ?>     
