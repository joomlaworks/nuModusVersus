...
<div id="nuContentModuleBox<?php echo $module->id; ?>" class="modItemsBlock nuContentItemsBlock<?php //if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <div class="moduleItemBody">
      ...
      <?php endif; ?>
        ...
        <div class="moduleItemAuthor"><?php echo JText::_('NUCONTENT_BY') ;?> <?php echo $item->author; ?></div>
        <?php endif; ?>
