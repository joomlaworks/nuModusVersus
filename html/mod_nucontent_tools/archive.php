...
<div id="nuContentModuleBox<?php echo $module->id; ?>" class="modArchivesBlock nuContentArchivesBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  <ul>
