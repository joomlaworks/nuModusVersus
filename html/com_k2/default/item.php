...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">	   
  	<div class="itemHeaderInner">
  	  ...
  	  <?php if($this->item->params->get('itemDateCreated') || $this->item->params->get('itemAuthor') || $this->item->params->get('itemCategory') || $this->item->params->get('itemCommentsAnchor') || ($this->item->params->get('itemTags') && count($this->item->tags))): ?>
  		...
  		<ul>
  			...
  			<li>
  				...
  				<a href="#" id="fontDecrease">
  					<?php /* <span><?php echo JText::_('K2_DECREASE_FONT_SIZE'); ?></span>
  				...
  				<a href="#" id="fontIncrease">
  					<?php /* <span><?php echo JText::_('K2_INCREASE_FONT_SIZE'); ?></span>
  			...
  			<!-- Print Button -->
  			<li>
  				<a class="itemPrintLink" title="<?php echo JText::_('K2_PRINT'); ?>" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
  			...
  			<!-- Email Button -->
  			<li>
  				<a class="itemEmailLink" title="<?php echo JText::_('K2_EMAIL'); ?>" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
  			...
  			<li>
  				<a class="itemVideoLink k2Anchor" href="<?php echo $this->item->link; ?>#itemVideoAnchor" title="<?php echo JText::_('K2_MEDIA'); ?>"><i class="icon-film"></i></a>
  			</li>
  			<?php endif; ?>
  			...
  			<li>
  				<a class="itemImageGalleryLink k2Anchor" href="<?php echo $this->item->link; ?>#itemImageGalleryAnchor" title="<?php echo JText::_('K2_IMAGE_GALLERY'); ?>"><i class="icon-picture"></i></a>
  			</li>
  			<?php endif; ?>			
  		</ul>
  		<div class="clr"></div>
  ...
  <div class="itemBody">
	  ...
	  <?php endif; ?>
		...
		<div class="itemContentFooter">
			...
			<!-- Item Hits -->
			<span class="itemHits">
				<i class="icon-eye-open"></i> <?php echo $this->item->hits; ?><?php /* echo JText::_('K2_READ'); ?> <b><?php echo $this->item->hits; ?></b> <?php echo JText::_('K2_TIMES'); */?>
			</span>
			<?php endif; ?>
...
($this->item->params->get('itemNavigation') && !JRequest::getCmd('print') && (isset($this->item->nextLink) || isset($this->item->previousLink)))): ?>
  ...
  <div class="itemComments">
	  ...
	  <ul class="itemCommentsList">
        ...
        <div class="commentHeader">
            ...
            <?php echo JHTML::_('date', $comment->commentDate, 'd F Y, H:i'); ?>
          </span>  		    
