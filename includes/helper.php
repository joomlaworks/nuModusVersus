...
if ($nutpGoogleWebFonts && !isset($nutpGoogleWebFonts->fonts)) {
    ...
    if (JFile::exists(JPATH_SITE.'/templates/'.$app->getTemplate().'/includes/elements/cache/gwf.json')) {
        ...
        $fontsData = json_decode(JFile::read($field->getFile('https://cdn.joomlaworks.org/gwf/gwf.php')));
    }
...
$socialProviders = array(
    ...
    "siteSocialYouTube" => "https://www.youtube.com/",
    "siteSocialVimeo" => "https://vimeo.com/",
    "siteSocialDailymotion" => "https://www.dailymotion.com/",
    "siteSocialSoundCloud" => "https://soundcloud.com/",
    "siteSocialMixCloud" => "https://www.mixcloud.com/",
    "siteSocialFlickr" => "https://www.flickr.com/photos/",
    "siteSocialInstagram" => "https://instagram.com/",
    "siteSocialPinterest" => "https://pinterest.com/",
    "siteSocial500px" => "https://500px.com/",
    "siteSocialDribbble" => "https://dribbble.com/",
    "siteSocialBehance" => "https://www.behance.net/",
...
if (!defined('NU_CDN')) {
    define('NU_CDN', 'https://cdn.joomlaworks.org');
}
